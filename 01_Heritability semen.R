library(blupADC)
data_path="D:/4.Rpractice/blupADC/multrait"
setwd("D:/4.Rpractice/blupADC/multrait")
...
run_DMU(
  ...
  target_trait_name=list(c('SV'),c('SC'),c('SM'),c('AB')),                     
  fixed_effect_name=list(c('Farm_Year_Season', 'Strain'),
                         c('Farm_Year_Season', 'Strain'),
                         c('Farm_Year_Season', 'Strain'),
                         c('Farm_Year_Season', 'Strain')),
  random_effect_name=list(c("ID"),c("ID"),c("ID"),c("ID")),
  ...
  included_permanent_effect=list(c(TRUE),c(TRUE),c(TRUE),c(TRUE)),  
  phe_path=data_path,
  ...
  output_result_path="D:/4.Rpractice/blupADC/multrait"   
) 
